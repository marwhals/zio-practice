...
object Essentials {
  ...
  // options and try
  val anOption: Option[Int] = Option(/* something that might be null */ 3)
  ...
  // Futures --- TODO check out the trade off -- Scala 3 uses: May want to use "given" instead of "implicit val". See contextual abstractions.
